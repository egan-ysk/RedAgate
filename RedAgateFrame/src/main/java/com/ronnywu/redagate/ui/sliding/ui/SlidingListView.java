...
/**
 * 对ListView 进行扩展,实现 SlidingWatch 接口.
 * 本控件依赖于 FreeSlidingLayout 使用.
 *
 * @author ronnywu
 * @date 2015-12-10
 * @time 11:24:58
 */
public class SlidingListView extends ListView implements SlidingWatch {
    ...
    public SlidingListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
